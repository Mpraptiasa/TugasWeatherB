...
const windIcon = require('./img/city.png');
...
constructor(props) {
  ...
  try {
    let response = await fetch(
      'http://api.openweathermap.org/data/2.5/weather?q='+ this.state.city + '&appid=bbb7bf8782d6563d159aec580183c206&units=metric'
    );
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      <View style={styles.box2}>
          ...
          <Text style={{ textAlign: 'center', paddingTop: 15, paddingBottom: 15,fontSize: 20 }}>Masukan Kota Anda</Text>
          <TextInput
                style={{ height: 40, color: 'white', padding: 9, width: 150}}
